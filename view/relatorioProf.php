  ...
  <body>
    ...
    <?php   
      ...
      if (isset($lotacoes)) {
        ...
        $content = "<table class='header'>
        <tr>
        <td><strong>Ofertas Ciências da Computação - Bacharelado - Semestre: " . substr($periodo, 0, 4) . "." . substr($periodo, 4, 1) . " - Ofício " . $_POST['num_ofc'] . "</strong></td>
        </tr>
        </table>
        <br>
        <table class='content'>
